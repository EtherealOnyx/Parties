    ...
    public static void postInit(FMLLoadCompleteEvent event) {
        ...
        event.enqueueWork(() -> {
            if (PRHandler.exists() || HRHandler.exists()) {
                ...
                ((PHealth)RenderItem.items.get("health")).updateRendererForMods();
            }
