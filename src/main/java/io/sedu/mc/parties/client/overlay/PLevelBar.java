...
public class PLevelBar extends RenderIconTextItem implements TooltipItem {
    ...
    void renderElement(PoseStack poseStack, ForgeIngameGui gui, Button b) {
        ...
        blit(poseStack, b.x+2, b.y+6, 0, 64, 10, 5);
        blit(poseStack, b.x+12, b.y+6, 172, 64, 10, 5);
        int w = (int) (20*bar);
        if (w > 10) {
            blit(poseStack, b.x+2, b.y+6, 0, 69, 10, 5);
            blit(poseStack, b.x+12, b.y+6, 172, 69, w-10, 5);
        } else {
        ...
        int x = b.x + 12 - (gui.getFont().width(level)>>1);
        int y = b.y + 5;
