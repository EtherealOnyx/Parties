...
public class PManaI extends BarBase {

    public PManaI(String name) {
    ...
    private void renderMana(int i, PoseStack poseStack, ManaIAnim mana) {
    ...
    private void renderManaAnim(int i, PoseStack poseStack, ManaIAnim mana, float partialTicks) {
    ...
    protected ConfigOptionsList getConfigOptions(SettingsScreen s, Minecraft minecraft, int x, int y, int w, int h, boolean parse) {
        ...
        c.addSliderEntry("ttype", 0, () -> 2, ManaIAnim.type);
    ...
    public SmallBound setTextType(int d) {
        return ManaIAnim.setTextType(d);
    }

    @Override
    public int getTextType() {
        return ManaIAnim.getTextType();
    }
