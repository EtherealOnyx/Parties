...
public class PManaUpdated extends BarBase {

    public PManaUpdated(String name) {
    ...
    @Override
    void renderSelfBar(int i, ClientPlayerData id, ForgeIngameGui gui, PoseStack poseStack, float partialTicks) {
        if (id.isDead) {
            if (iconEnabled) {
